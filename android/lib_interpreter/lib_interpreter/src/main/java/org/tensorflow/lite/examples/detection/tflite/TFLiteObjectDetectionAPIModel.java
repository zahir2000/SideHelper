...
public class TFLiteObjectDetectionAPIModel implements Detector {
  ...
  public static Detector create(
    ...
    d.labels.add("Bicycle");
    d.labels.add("Person");
    d.labels.add("Car");
    d.labels.add("Tree");
    d.labels.add("Pole");
    d.labels.add("Fire hydrant");
    d.labels.add("Trash can");
    d.labels.add("Cone");
    d.labels.add("Dog");
    d.labels.add("Motorcycle");
    d.labels.add("Pothole");
    d.labels.add("Sidewalk");

    //'Bicycle', 'Person', 'Car', 'Tree', 'Pole', 'Firehydrant', 'Trash can', 'Cone', 'Dog', 'Motorcycle', 'Pothole', 'Sidewalk'

    //Log.d("zahir", list.get(0));
