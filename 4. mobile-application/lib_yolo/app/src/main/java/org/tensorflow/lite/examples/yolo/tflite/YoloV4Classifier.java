...
package org.tensorflow.lite.examples.yolo.tflite;
...
import org.tensorflow.lite.examples.yolo.DetectorActivity;
import org.tensorflow.lite.examples.yolo.MainActivity;
import org.tensorflow.lite.examples.yolo.env.Logger;
import org.tensorflow.lite.examples.yolo.env.Utils;
...
public class YoloV4Classifier implements Classifier {
    ...
    // config yolov4 tiny
    public static int INPUT_SIZE = DetectorActivity.TF_OD_API_INPUT_SIZE;
    public static int[] OUTPUT_WIDTH_TINY = new int[]{1500, 1500};
    //private static final int[] OUTPUT_WIDTH_TINY = new int[]{1500, 1500};
    public static int[] OUTPUT_WIDTH_FULL = new int[]{6300, 6300};
...
//    }
    ...
    private ArrayList<Recognition> getDetectionsForTiny(ByteBuffer byteBuffer, Bitmap bitmap) {
        ...
        LOGGER.i("detectui" + OUTPUT_WIDTH_TINY[0]);
        tfLite.runForMultipleInputsOutputs(inputArray, outputMap);
